# 版本更新记录
## [2.16.116] - 2026-02-27
- 更新 `@netless/app-slide` 至 0.2.96。
  - 修复直接使用 Img 标签上传 CPU 纹理
  - 修复因悟空需求缩放导致的白板左右两侧会隐藏部分笔记问题
## [2.16.115] - 2026-01-20
...
## [2.16.110] - 2025-10-16
- 更新 `@netless/app-slide` 至 0.2.82
## [2.16.109] - 2025-09-09
- 更新 `@netless/app-slide` 到 0.2.81, 添加文本框rot属性, 解决部分PPT内文本倒置问题
## [2.16.108] - 2025-08-22
...
- 新增 `MemberState.fillColor`, 用于更改填充颜色，仅在 `WhiteSdkConfiguration.enableAppliancePlugin` 启用时有效。
## [2.16.97] - 2025-02-18
- 更新 `@netless/appliance-plugin` 至 1.1.9, 修复配置 `RoomParams.floatBar` 不生效问题。
## [2.16.96] - 2025-01-02
- 更新 `@netless/app-slide` 至 0.2.63, 修复鸿蒙端首次渲染图片不显示问题。
## [2.16.95] - 2024-11-06
- 更新 `@netless/appliance-plugin` 至 1.1.2, 修复只读模式下房间写状态异常的问题。
## [2.16.94] - 2024-10-31
...
- 更新 `@netless/appliance-plugin` 至 1.1.0
## [2.16.92] - 2024-09-05
