...
public class PptResourceCacheActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pptResourceManager = PptResourceManager.getInstance();
        pptResourceManager.setPptCacheDir(getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS).getAbsolutePath() + "/pptdownload");
    ...
    private void alert(final String title, final String detail) {
        runOnUiThread(() -> {
            AlertDialog alertDialog = new AlertDialog.Builder(PptResourceCacheActivity.this).create();
    ...
    public void reconnect(MenuItem item) {
        ...
        mRoom.disconnect(new Promise<Object>() {
            ...
            public void then(Object b) {
                joinRoom(PptResourceCacheActivity.this.uuid, PptResourceCacheActivity.this.token);
            }
    ...
    public void orientation(MenuItem item) {
        if (getRequestedOrientation() == ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE) {
            PptResourceCacheActivity.this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        } else {
            PptResourceCacheActivity.this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
        }
    }
